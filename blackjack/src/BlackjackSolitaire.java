...
public class BlackjackSolitaire {
	...
	/**
	 * This method runs the whole game, including creating deck and shuffling,
	 * dealing, allowing user to select where cards should be placed, displaying
	...
	public void play() {
		...
		//This while loop controls the flow of the game: dealing cards, 
		...
		while (myTable.fullTable() == false) {
			...
			//Discards a card in the next open spot, after checking for availability.
			if (playSpot == 0) {
				if (myTable.fullDiscard() == false) {
			...
			// isn't valid.
			else if (myTable.betterplayCard(playSpot, currentCard) == false) {
